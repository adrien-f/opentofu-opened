...
import (
	...
	"github.com/adrien-f/opentofu-opened/pkg/backend"
	...
	backendRemote "github.com/adrien-f/opentofu-opened/pkg/backend/remote"
	backendAzure "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/azure"
	backendConsul "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/consul"
	backendCos "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/cos"
	backendGCS "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/gcs"
	backendHTTP "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/http"
	backendInmem "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/inmem"
	backendKubernetes "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/kubernetes"
	backendOSS "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/oss"
	backendPg "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/pg"
	backendS3 "github.com/adrien-f/opentofu-opened/pkg/backend/remote-state/s3"
	backendCloud "github.com/adrien-f/opentofu-opened/pkg/cloud"
)
