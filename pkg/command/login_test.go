...
import (
	...
	oauthserver "github.com/adrien-f/opentofu-opened/pkg/command/testdata/login-oauth-server"
	tfeserver "github.com/adrien-f/opentofu-opened/pkg/command/testdata/login-tfe-server"
