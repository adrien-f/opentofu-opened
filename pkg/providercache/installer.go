...
import (
	...
	copydir "github.com/adrien-f/opentofu-opened/pkg/copy"
...
NeedProvider:
	...
	for provider, version := range need {
		...
		// This is only intended to be temporary, see https://github.com/adrien-f/opentofu-opened/issues/266 for more information
